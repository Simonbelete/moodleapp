...
import { CoreLanguagePreferencePage } from '@features/language/pages/preference/preference';
...
const routes: Routes = [
    {
        path: 'language',
        component: CoreLanguagePreferencePage,
    },
];

@NgModule({
    declarations: [
        CoreLanguagePreferencePage,
    ],
    imports: [
...
export class CoreLanguagePreferenceModule {}
